...
static __maybe_unused const struct regval imx415_linear_10bit_1920x1080_1485M_regs[] = {
    {0x3008, 0x7F},
    {0x300A, 0x5B},
    {0x301C, 0x04},
    {0x3024, 0xFD},
...
static const struct imx415_mode supported_modes[] = {
	...
	},
	{
		...
		.exp_def = 0x05fd - 0x08,
		.hts_def = 0x071a * IMX415_4LANES * 2,
		.vts_def = 0x05fd,
		.global_reg_list = imx415_global_10bit_3864x2192_regs,
		.reg_list = imx415_linear_10bit_1920x1080_1485M_regs,
		.hdr_mode = NO_HDR,
		.mipi_freq_idx = 1,
		.bpp = 10,
		.vc[PAD0] = 0,
